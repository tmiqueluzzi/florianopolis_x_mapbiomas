...
Análise espaço-temporal automatizada do uso do solo no município de Florianópolis (SC)

Este repositório apresenta um projeto de geoprocessamento e análise espacial que investiga como o uso e a cobertura do solo em Florianópolis evoluíram ao longo de quase 40 anos, utilizando dados oficiais do MapBiomas e automação em Python.
